// ============================================================
// MKTG 6090 mock test — draws a random subset of multiple-choice
...
document.addEventListener('DOMContentLoaded', initMktgMockTest);

function initMktgMockTest(){
  ...
  // Prefer a combined multi-unit pool if the page provides one (MKTG_MOCK_POOL / MKTG_MOCK_LABELS),
  // otherwise fall back to the single-unit QUIZ_QUESTIONS / SOURCE_LABELS globals.
  const QUESTION_POOL = (typeof MKTG_MOCK_POOL !== 'undefined') ? MKTG_MOCK_POOL
    : (typeof QUIZ_QUESTIONS !== 'undefined' ? QUIZ_QUESTIONS : null);
  const LABELS = (typeof MKTG_MOCK_LABELS !== 'undefined') ? MKTG_MOCK_LABELS
